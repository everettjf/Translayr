...
struct LanguageSettingsView: View {
    ...
    var body: some View {
        Form {
            Section {
                Text("Select which language Translayr should detect and translate")
                    .font(.callout)
            ...
            Section("Source Language (Detect)") {
                ...
                HStack(alignment: .top, spacing: 8) {
                    ...
                    Text("Translayr will detect \(selectedLanguage.displayName) text in other applications")
                        .font(.caption)
                        .foregroundColor(.secondary)
                ...
                VStack(alignment: .leading, spacing: 12) {
                    HStack(alignment: .top, spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text("Detection")
                                .font(.callout.weight(.semibold))
                            Text("Translayr monitors text in other applications and detects \(selectedLanguage.displayName) characters")
                                .font(.caption)
                                .foregroundColor(.secondary)
                        }
                    }
